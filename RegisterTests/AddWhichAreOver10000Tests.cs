...
{
    [TestClass()]
    public class AddWhichAreOver10000Tests
    {
        [DataTestMethod()]
        [DataRow("Harry Potter", "fantasy", "Allma Littera", "2010-10-07", 350, 1000000, "ISBN-466799", "J.K. Rowling", 1)]
        [DataRow("Public library", "comedy", "Allma Littera", "2009-11-20", 200, 5000, "ISBN-555333", "Anonymous", 0)]
        [DataRow("Vincas Kudirka's biography", "historical", "Obuolys", "2010-07-25", 150, 10000, "ISBN-379155", "Kazys Grinius", 0)]
        public void AddWhichAreOver10000_CheckIfCountIsRight_True(string name, string type, string publisher, string releaseDate, int pageCount, int circulation, string ISBN, string author, int count)
        {
            ...
            register.AddWhichAreOver10000(ref filtered);
