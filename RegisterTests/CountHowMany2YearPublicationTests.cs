...
{
    [TestClass()]
    public class CountHowMany2YearPublicationTests
    {
        [DataTestMethod()]
        [DataRow("Harry Potter", "fantasy", "Allma Littera", "2023-10-07", 350, 1000000, "ISBN-466799", "J.K. Rowling", 0)]
        ...
        public void CountHowMany2YearOldCreations_CheckIfAmountIsRight_True(string name, string type, string publisher, string releaseDate, int pageCount, int circulation, string ISBN, string author, int count)
        {
            ...
            Assert.AreEqual(count, register.CountHowMany2YearOldCreations());
        }
    }
}
